...
::: collapse Install the Python Packages
...
::: collapse {open} Run the demo

![](assets/labs/demo_gamepad/data/images/xbox_mappings_demos.jpg)
...
#runsofa-button(file="assets/labs/demo_gamepad/demo_gamepad.py")
:::
